...
const page = () => {
  ...
  <div className="container mx-auto px-5 py-24">
    <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
     ...
     <div className="w-full lg:w-1/2">
            <h1 className="bg-linear-to-r text-2xl from-white via-slate-200 to-emerald-400 bg-clip-text text-transparent">
              Support Montreal — Build a Kinder Future Together
            </h1>

            <p className="leading-relaxed mt-4">
              Join hands to support communities across Montreal. From education,
              healthcare, and food security to environmental care, every
              contribution helps create real impact in people’s lives.
            </p>
          </div>
  ...
  Login to Get Started
            ...
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 flex flex-col gap-4 items-center shadow-2xl">
              <button   onClick={() => {
